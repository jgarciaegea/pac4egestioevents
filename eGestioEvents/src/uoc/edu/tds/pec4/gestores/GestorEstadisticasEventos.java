...
import uoc.edu.tds.pec4.daos.DaoEstadisticasEventos;
import uoc.edu.tds.pec4.dtos.DTOEstadisticas;

public class GestorEstadisticasEventos extends GestorEntidad<DTOEstadisticas>{

	public GestorEstadisticasEventos(Connection connection) throws Exception {
		super(connection);
	}
	...
	public List<DTOEstadisticas> consultaEntidades(DTOEstadisticas criteris) throws Exception {
		try{
			DaoEstadisticasEventos dao = new DaoEstadisticasEventos(connection);
